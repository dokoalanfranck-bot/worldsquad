...
export default async function MatchesPage() {
  ...
  const [matches, { data: predictions }, { data: profile }, flashChallenges] = await Promise.all([
    getMatches(),
  ...
  const flashMatchIds = new Set(flashChallenges.map((fc) => fc.match_id))
