...
const SCRIPTS: AdScript[] = [
  {
    ...
    subtitle: 'Le script général — présentation complète',
    tone: 'Énergique',
    toneColor: 'text-blue-400',
    toneBg: 'bg-blue-500/15 border-blue-500/30',
    duration: '~55 sec',
    description: 'Idéal pour une première vidéo de présentation. Couvre tout : pronostics, cartes, battles, ligues.',
    lines: [
      { type: 'direction', text: "Face caméra, souriant — debout ou assis, cadrage mi-buste" },
      { type: 'speech', text: "La Coupe du Monde 2026 arrive. 104 matchs. 48 nations." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Et toi... tu vas juste regarder comme tout le monde ?" },
      { type: 'direction', text: "Ton qui monte légèrement" },
      { type: 'speech', text: "Non. Avec WorldSquad, tu joues vraiment." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Tu pronostics les scores de chaque match — score exact, c'est 300 coins. Tu ouvres des packs de cartes joueurs — Mbappé, Messi, Vinicius — avec des effets holographiques. Tu défies tes amis en battle, la meilleure carte l'emporte." },
      { type: 'direction', text: "Montrer l'écran du téléphone si possible" },
      { type: 'speech', text: "Et tout ça dans une ligue privée avec tes potes. Classement en temps réel. Qui va prédire la finale ?" },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Regard direct caméra — ton calme et assuré" },
      { type: 'speech', text: "WorldSquad, c'est la Coupe du Monde version jeu. Gratuit. Addictif. Le meilleur pronostiqueur empoche la gloire." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Sourire — pointer vers le bas pour le lien en bio" },
      { type: 'speech', text: "500 coins offerts à l'inscription. Le lien, c'est en bio. À tout de suite." },
    ],
  },
  {
    id: 2,
    title: 'Joue avec tes potes',
    subtitle: "L'angle social — ligue privée entre amis",
    tone: 'Décontracté',
    toneColor: 'text-green-400',
    toneBg: 'bg-green-500/15 border-green-500/30',
    duration: '~58 sec',
    description: "Cible les groupes d'amis. Met en avant la ligue privée, le classement, les battles entre potes.",
    lines: [
      { type: 'direction', text: "Décontracté — comme si tu parles à un ami, sourire naturel" },
      { type: 'speech', text: "Dis-moi... t'as déjà perdu un pari avec tes potes sur un match de foot ?" },
      { type: 'direction', text: "Petite pause — sourire" },
      { type: 'speech', text: "Avec WorldSquad, ça devient officiel." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Tu crées ta ligue privée — un code secret — tes amis rejoignent. Chaque match de la Coupe du Monde, vous pronostiques le score tous ensemble." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Score exact ? Plus 300 coins. Bon vainqueur ? Plus 100." },
      { type: 'direction', text: "Ton qui monte — plus animé" },
      { type: 'speech', text: "Et si t'es chaud, tu défies quelqu'un en battle. Tu poses ta carte, il pose la sienne. La meilleure stat gagne ses coins." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Pointer vers soi — ton affirmé" },
      { type: 'speech', text: "À la fin du Mondial ? Celui qui est premier dans votre ligue... c'est lui le boss. Définitivement." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Calme, direct — conclure avec le sourire" },
      { type: 'speech', text: "Gratuit. 30 secondes pour s'inscrire. 500 coins offerts direct." },
      { type: 'speech', text: "Fais-le. Ton groupe de potes attend." },
    ],
  },
  {
    id: 3,
    title: 'Les cartes Légendaires',
    subtitle: "L'angle collector — packs et raretés",
    tone: 'Enthousiaste',
    toneColor: 'text-purple-400',
    toneBg: 'bg-purple-500/15 border-purple-500/30',
    duration: '~52 sec',
    description: "Cible les fans de FIFA FUT et Panini. Met l'accent sur l'ouverture de packs et les cartes Legend.",
    lines: [
      { type: 'direction', text: "Enthousiaste, énergique — montrer de l'excitation authentique" },
      { type: 'speech', text: "T'aimes FIFA Ultimate Team ? T'aimes les Panini ?" },
      { type: 'direction', text: "Pause — sourire complice" },
      { type: 'speech', text: "Alors WorldSquad, c'est fait pour toi." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Plus de 1200 cartes joueurs. Avec les vraies photos. Des raretés : Common, Rare, Epic... et la Légendaire." },
      { type: 'direction', text: "Expressif — simuler une ouverture de pack avec les mains" },
      { type: 'speech', text: "Quand t'ouvres un pack et que tu tombes sur une carte Legend — les effets, les particules, la musique — je te jure, tu cries." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Tu gagnes des coins en pronostiquant les matchs de la Coupe du Monde 2026. Et avec tes cartes, tu bats tes amis en battle un contre un." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Ralentir pour l'impact — prononcer chaque mot distinctement" },
      { type: 'speech', text: "Collection. Stratégie. Compétition." },
      { type: 'speech', text: "C'est WorldSquad." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Direct caméra — pointer vers le bas" },
      { type: 'speech', text: "500 coins offerts à l'inscription. Le lien est en bio. Ouvre ton premier pack." },
    ],
  },
  {
    id: 4,
    title: 'Le meilleur pronostiqueur',
    subtitle: "L'angle compétitif — prédictions et classement",
    tone: 'Compétitif',
    toneColor: 'text-orange-400',
    toneBg: 'bg-orange-500/15 border-orange-500/30',
    duration: '~57 sec',
    description: "Cible les fans de paris sportifs et de compétition. Met en avant la précision et le défi entre joueurs.",
    lines: [
      { type: 'direction', text: "Confiant, direct — regarder légèrement de côté puis face caméra" },
      { type: 'speech', text: "T'as déjà regardé un match en sachant à l'avance comment ça allait finir... et t'avais raison ?" },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Petite pause dramatique" },
      { type: 'speech', text: "Imagine que ça te rapporte quelque chose." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "WorldSquad, c'est le jeu de pronostics de la Coupe du Monde 2026. 104 matchs. Tu prédis les scores, les vainqueurs, les buteurs. Chaque bonne prédiction, c'est des coins." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Ces coins, tu les utilises pour ouvrir des packs de cartes, défier tes amis en battle, ou grimper en tête de ta ligue privée." },
      { type: 'direction', text: "Ton ferme — marquer un temps d'arrêt avant" },
      { type: 'speech', text: "Pas d'argent réel. Pas de risque. Juste la compétition pure." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Le meilleur pronostiqueur à la fin du Mondial aura prouvé qu'il était le boss." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Direct — pointer vers soi, puis vers le spectateur" },
      { type: 'speech', text: "Inscris-toi. 500 coins offerts. Link en bio." },
    ],
  },
  {
    id: 5,
    title: 'Le compte à rebours',
    subtitle: "L'angle urgence — FOMO avant le coup d'envoi",
    tone: 'Urgent',
    toneColor: 'text-red-400',
    toneBg: 'bg-red-500/15 border-red-500/30',
    duration: '~50 sec',
    description: "Crée le sentiment d'urgence — à utiliser proche du 11 juin 2026. Fort FOMO. Court et percutant.",
    lines: [
      { type: 'direction', text: "Sérieux, regard direct — debout, cadrage serré mi-buste" },
      { type: 'speech', text: "Le 11 juin 2026." },
      { type: 'direction', text: "Pause — laisser la date s'installer" },
      { type: 'speech', text: "France. Brésil. Argentine. Les meilleurs joueurs du monde." },
      { type: 'speech', text: "La Coupe du Monde commence." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Et toi, t'es prêt ?" },
      { type: 'direction', text: "Ton qui monte progressivement" },
      { type: 'speech', text: "Parce que sur WorldSquad, tes adversaires construisent déjà leur collection. Tes amis ont déjà lancé leur ligue. Quelqu'un va déjà être en tête du classement." },
      { type: 'direction', text: "Pause — laisser le FOMO s'installer, regard dans les yeux" },
      { type: 'speech', text: "WorldSquad, c'est simple : tu pronostics les matchs, t'ouvres des packs de cartes joueurs, tu bats tes amis en battle." },
      { type: 'speech', text: "Gratuit. En ligne. Addictif." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Direct, urgent — ton final percutant" },
      { type: 'speech', text: "Rejoins maintenant. 500 coins offerts." },
      { type: 'speech', text: "Tu te prépares comme les pros... ou tu regardes les autres jouer." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "Le lien. En bio. Maintenant." },
    ],
  },
]
