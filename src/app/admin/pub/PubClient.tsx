...
const SCRIPTS: AdScript[] = [
  {
    ...
    duration: '~55 sec',
    description: 'Script de présentation équilibré. Cartes en premier, pronostics comme moyen de jouer, battles comme finalité sociale.',
    lines: [
      { type: 'direction', text: "Face caméra, souriant — debout ou assis, cadrage mi-buste" },
      { type: 'speech', text: "T'imagines avoir les cartes de Mbappé, Messi et Vinicius dans ta poche... et les utiliser pour écraser tes amis ?" },
      { type: 'pause', text: '' },
      { type: 'speech', text: "C'est exactement ça WorldSquad." },
      { type: 'pause', text: '' },
      { type: 'speech', text: "WorldSquad c'est un jeu de cartes collectibles autour de la Coupe du Monde 2026. Plus de 1200 cartes joueurs avec de vraies photos — raretés Common, Rare, Epic et Légende. Tu ouvres des packs, tu construis ta collection, et tu défies tes amis en battle. La meilleure carte l'emporte." },
      { type: 'direction', text: "Montrer l'écran du téléphone si possible" },
      { type: 'speech', text: "Pour avoir des coins et ouvrir des packs, tu joues les matchs du Mondial — tu prédis les scores, tu regardes tes cartes monter en valeur." },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Regard direct caméra — ton calme et assuré" },
      { type: 'speech', text: "Crée ta ligue avec tes amis. Classement en temps réel. Qui a la meilleure collection ? Qui va tout écraser en battle ?" },
      { type: 'pause', text: '' },
      { type: 'direction', text: "Sourire — pointer vers le bas pour le lien en bio" },
      { type: 'speech', text: "Gratuit. 500 coins offerts à l'inscription. Le lien, c'est en bio." },
    ],
  },
  {
    id: 2,
