...
export const PACK_CONFIGS = {
  common: {
    ...
    cost: 200,
    cards: 5,
    odds: { Common: 0.75, Rare: 0.20, Epic: 0.05, Legend: 0.00 },
    color: '#9CA3AF',
    icon: '📦',
  },
  rare: {
    ...
    cost: 500,
    cards: 5,
    odds: { Common: 0.45, Rare: 0.35, Epic: 0.15, Legend: 0.05 },
    color: '#00D4FF',
    icon: '💎',
  },
  elite: {
    ...
    cost: 2000,
    cards: 8,
    odds: { Common: 0.20, Rare: 0.40, Epic: 0.30, Legend: 0.10 },
    color: '#A855F7',
    icon: '👑',
  },
  legend: {
    ...
    cost: 5000,
    cards: 8,
    odds: { Common: 0.00, Rare: 0.00, Epic: 0.60, Legend: 0.40 },
    color: '#F5C518',
    icon: '⚡',
  },
} as const
